...
- `tools/thistle-editor` — the Thistle Editor, a 3D level editor for `three::Scene3D` files, drawn with the engine's own 2D API. See its README for what's been verified by clicking through it.
